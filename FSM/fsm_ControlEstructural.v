...
module fsmControlEstructural(clk, reset, init, umbral_MF, umbral_D, umbral_VC, FIFO_error, FIFO_empty, umbrales_I, active_out, idle_out, error_out);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
